        ...
        <>
          <div className="header">
            <div className="sidebar-logo">
              <img src="resolvIT-logo.png" alt="Logo" />
            </div>
            <div className="title">
          ...
          <div className="menu">
            ...
            >
              <img src="home-icon-side.png" alt="Home" width={23} />
