    ...
    <div className="form15-page">
      ...
      <div className="form15-text">
        ...
        <div className="form15-container">
          <form className="form15">
            ...
            <div className="form15-pormularyoblg">
              <label className="form15-pormularyo">
                Pormularyo ng KP Blg. 15
              </label>
            </div>
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group">
                ...
                <input
                  type="text"
                  id="form15Ipinagsumbong"
                  onChange={handleInputChange}
                />{" "}
                <br />
                <input
                  type="text"
                  id="form15Ipinagsumbong1"
                  onChange={handleInputChange}
                />
                <label className="form15-sumbong">
                  {" "}
        ...
        <div className="form15-button-group">
          ...
          {/* Submit Button */}
          <button className="form15-next-button" onClick={handleSubmit}>
            Submit
          </button>
        </div>
