...
const Form7 = () => {
  ...
  return (
    <div className="form7-page">
      ...
      {/* Pop-up Modal */}
      {showPopup && (
        <div className="form7-popup-overlay">
          <div className="form7-popup-content">
            <img
            ...
            <h2>Success!</h2>
            <p>
              Form 7 successfully submitted. Please click the button to
              continue to Complaints page.
            </p>
            <button
              className="form7-popup-continue-button"
