        ...
        <form>
          ...
          <div className="form-row two-columns centered-row">
            <div className="form-group">
              ...
              <input
                type="text"
                id="form7Ipinagsumbong"
                onChange={handleInputChange}
              />{" "}
              <br />
              <input
                type="text"
                id="form7Ipinagsumbong1"
                onChange={handleInputChange}
              />{" "}
              <br />
          ...
          <div className="form7-paragraph">
            <label className="form7-justify">
              ...
              binanggit sa itaas dahil sa paglabag sa aking/aming mga karapatan
              at kapakanan sa sumusunod na pamamaraan:
