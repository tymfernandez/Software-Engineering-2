    ...
    <div className="form17-page">
      ...
      <div className="form17-text">
        ...
        <div className="form17-container">
          <form className="form17">
            ...
            <div className="form17-pormularyoblg">
              <label className="form17-pormularyo">
                Pormularyo ng KP Blg. 17
              </label>
            </div>
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group">
                ...
                <input
                  type="text"
                  id="form17Ipinagsumbong"
                  onChange={handleInputChange}
                />{" "}
                <br />
                <input
                  type="text"
                  id="form17Ipinagsumbong1"
                  onChange={handleInputChange}
                />
                <label className="form17-sumbong">
                  {" "}
            ...
            <br />
            <div className="form17-paragraph">
              <label className="form17-left">(Lagyan ng tsek ang angkop)</label>
            </div>
            <div className="form17-checkbox-container">
              <div className="form17-checklist">
                <div className="form17-checkbox-item">
                  ...
                  />
                  <label
                    for="form17-checkbox1"
                    className="form17-checkbox-label"
                  >
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group">
                <label className="form17-mgasumbong">(Mga) May Sumbong</label>
            ...
            <div className="form17-form-input">
              ...
              <input
                type="text"
                id="form17DayReceived"
                onChange={handleInputChange}
              />
              <label>araw ng</label>
              <input
                type="text"
                id="form17MonthReceived"
                onChange={handleInputChange}
              />
              <label>, 20</label>
              <input
                type="text"
                id="form17YearReceived"
                onChange={handleInputChange}
              />
              <label>.</label>
            </div>
        ...
        <div className="form17-button-group">
          ...
          {/* Submit Button */}
          <button className="form17-next-button" onClick={handleSubmit}>
            Submit
          </button>
        </div>
