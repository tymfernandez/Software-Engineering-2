    ...
    <div className="form16-page">
      ...
      <div className="form16-text">
        ...
        <div className="form16-container">
          <form className="form16">
            ...
            <div className="form16-pormularyoblg">
              <label className="form16-pormularyo">
                Pormularyo ng KP Blg. 16
              </label>
            </div>
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group">
                ...
                <input
                  type="text"
                  id="form16Ipinagsumbong"
                  onChange={handleInputChange}
                />{" "}
                <br />
                <input
                  type="text"
                  id="form16Ipinagsumbong1"
                  onChange={handleInputChange}
                />{" "}
                <br />
                <label className="form16-sumbong">
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group">
                <label className="form16-mgasumbong">(Mga) May Sumbong</label>
        ...
        <div className="form16-button-group">
          ...
          {/* Submit Button */}
          <button className="form16-next-button" onClick={handleSubmit}>
            Submit
          </button>
        </div>
        ...
        {showSuccess && (
          <div className="form9-popup-overlay">
            <div className="form9-popup-content">
              ...
              <h2>Success!</h2>
              <p>
                Form 16 successfully submitted. Please click the button to
