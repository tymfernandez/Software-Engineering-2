  ...
  return (
    <div className="form19-page">
      ...
      <div className="form19-text">
        ...
        <h2 className="form19-subtitle">
          PAG-ABISO NG PAGDINIG PARA SA RESPONDENT
        </h2>
        ...
        <div className="form19-container">
          <form className="form19">
            ...
            <div className="form19-pormularyoblg">
              <label className="form19-pormularyo">
                Pormularyo ng KP Blg. 19
              </label>
            </div>
            ...
            <div className="form-row two-columns centered-row">
              <div className="form-group-input">
                <label className="form19-mga-sumbong">(Mga) May Sumbong</label>{" "}
                <br /> <br />
              ...
              <div className="form-group-input">
                <label className="form19-mga-sumbong">
                  (Mga) Ipinagsusumbong{" "}
                </label>{" "}
                <br /> <br />
                <div className="form19-line"></div> <br /> <br /> <br />
        ...
        <div className="form19-button-group">
          ...
          {/* Submit Button */}
          <button className="form19-next-button" onClick={handleSubmit}>
            Submit
          </button>
        </div>
