    ...
    <div className="form25-page">
      ...
      <div className="form25-text">
        ...
        <div className="form25-container">
          <form className="form25">
            ...
            <div className="form25-pormularyoblg">
              <label className="form25-pormularyo">
                Pormularyo ng KP Blg. 25
              </label>
            </div>
            ...
            <div className="form-row two-columns centered-row">
              ...
              <div className="form25-form-group-input">
                ...
                <div className="form25-line"></div> <br /> <br /> <br />
                <div className="form25-line"></div>
                <label className="form25-mga-sumbong">
                  (Mga) Ipinagsusumbong{" "}
                </label>
              </div>
            </div>{" "}
        ...
        <div className="form25-button-group">
          ...
          {/* Submit Button */}
          <button className="form25-next-button" onClick={handleSubmit}>
            Submit
          </button>
        </div>
        ...
        {showSuccess && (
          <div className="form9-popup-overlay">
            <div className="form9-popup-content">
              ...
              <h2>Success!</h2>
              <p>
                Form 25 successfully submitted. Please click the button to
